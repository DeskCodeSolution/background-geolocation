...
public class BackgroundGeolocation extends Plugin {
    ...
    public void addWatcher(final PluginCall call) {
        mBound = getActivity().bindService(new Intent(getActivity(), BackgroundGeolocationService.class), new ServiceConnection() {
            @Override
            public void onServiceConnected(ComponentName cName, IBinder service) {
                try {
                    BackgroundGeolocationService.LocalBinder binder = (BackgroundGeolocationService.LocalBinder) service;
...
//    private BackgroundGeolocationService.LocalBinder service = null;
    ...
    private BackgroundGeolocationService mService = null;
